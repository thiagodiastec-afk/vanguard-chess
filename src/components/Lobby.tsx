          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1">
              <button
                ...
                disabled={isSearching}
                className="w-full font-bold py-4 px-4 rounded-2xl transition-all active:scale-95 flex items-center justify-center gap-2 text-base sm:text-lg bg-neutral-700 hover:bg-neutral-600 text-white disabled:opacity-50 disabled:cursor-not-allowed"
              >
                      ...
                      {hasSavedBotGame && (
                        <button
                          onClick={() => {
                            ...
                            onPlayComputer('resume');
                          }}
                          className="col-span-2 flex flex-col items-center justify-center px-4 py-4 bg-amber-500/20 hover:bg-amber-500/30 text-amber-400 transition-all rounded-2xl border border-amber-500/30 hover:border-amber-500/50 hover:scale-[1.02] active:scale-[0.98] animate-pulse"
                        >
            ...
            <button
              onClick={() => onPlayLocal?.()}
              disabled={isSearching}
              className="flex-1 font-bold py-4 px-4 rounded-2xl transition-all active:scale-95 flex items-center justify-center gap-2 text-base sm:text-lg bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-50 disabled:cursor-not-allowed"
            >
